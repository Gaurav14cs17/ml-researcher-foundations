<!-- Animated Header -->
<p align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=6,11,20&height=150&section=header&text=Gradient Descent&fontSize=36&fontColor=fff&animation=twinkling&fontAlignY=35" width="100%"/>
</p>
...
<img src="./images/gd-detailed.svg" width="100%">

*Caption: Gradient descent iteratively updates θ ← θ - η∇f(θ). Learning rate η is critical: too small = slow, too large = diverge. Variants include momentum, Nesterov, and weight decay.*
