<!-- Animated Header -->
<p align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=6,11,20&height=150&section=header&text=06 Linear Programming&fontSize=36&fontColor=fff&animation=twinkling&fontAlignY=35" width="100%"/>
</p>
...
> **Optimizing linear objectives with linear constraints**

## 🎯 Visual Overview

<img src="./images/linear-programming.svg" width="100%">

*Caption: LP minimizes cᵀx subject to Ax=b, x≥0. Optimal solution at polytope vertex. Simplex walks vertices (fast practice), Interior Point goes through interior (O(n³·⁵) polynomial).*
