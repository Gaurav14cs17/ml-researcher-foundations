<!-- Animated Header -->
<p align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=6,11,20&height=150&section=header&text=09 Metaheuristics&fontSize=36&fontColor=fff&animation=twinkling&fontAlignY=35" width="100%"/>
</p>
...
> **When gradients don't exist - evolution-inspired optimization**

## 🎯 Visual Overview

<img src="./images/metaheuristics.svg" width="100%">

*Caption: Metaheuristics for non-differentiable/discrete problems: Simulated Annealing (escapes local min), Genetic Algorithms (population evolution), Particle Swarm (collective search).*
